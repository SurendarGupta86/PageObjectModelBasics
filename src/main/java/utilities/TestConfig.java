...
public class TestConfig{
	...
	public static String from = "surendar4u@gmail.com";
	public static String password = "1amfkdup";
	public static String[] to ={"surendar.gupta86@gmail.com","surendar4u@gmail.com"};
